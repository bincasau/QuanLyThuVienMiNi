...
public class PdfController {
	...
	public void exportToPDF(int year) {
	    ...
	    String dest = "statistics_report_" + year + ".pdf";
	    ...
	    try (PDDocument document = new PDDocument()) {
	        ...
	        content.drawImage(barChartImage, margin, yStart - 320, 500, 300); // Điều chỉnh yStart để hiển thị phù hợp
	        ...
	        document.save(dest);
	        JOptionPane.showMessageDialog(null, "Tệp PDF đã được tạo tại: " + dest, "Thành công", JOptionPane.INFORMATION_MESSAGE);
